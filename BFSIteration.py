# find the degrees of separatations between superheroes
...
class MRBFSIteration(MRJob):
    ...
    def reducer(self, key, values): #finds the smallest distance
        edges = []
        distance = 9999
        color = 'WHITE'
...
#look for the lines "Target ID 100 was hit with distance"