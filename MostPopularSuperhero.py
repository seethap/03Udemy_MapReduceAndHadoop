# most popular superhero with max appearances 
# with other characters(allows repetition)
...
class MostPopularSuperHero(MRJob):
    ...
    def mapper_count_friends_per_line(self, _, line):
        fields = line.split()
        heroID = fields[0] #first value
        numFriends = len(fields) - 1 #total split count - 1
